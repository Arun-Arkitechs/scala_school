...
A partial function is only defined for certain values of defined types.

<pre>
scala> val testThis:PartialFunction[Int,String]= { case x if x <= 1 => "This input value defined in this function"}
scala> testThis.isDefinedAt(1)
res10: true
scala> testThis.isDefinedAt(2)
res11: false
</pre>
